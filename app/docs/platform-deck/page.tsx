...
export default async function PlatformDeckDocPage() {
  const absolute = path.join(process.cwd(), 'docs/platform-deck.md')
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-between gap-4 mb-6">
              <div>
                ...
                <div className="text-2xl font-bold text-navy-900">Platform Deck (20 slides)</div>
              </div>
